...
ARG VERSION=2.33.1
# docker build --build-arg VERSION=2.33.1 -t jheinecke/conllueditor:2.33.1 .
# docker build --build-arg VERSION=2.33.1 -t jheinecke/conllueditor:latest .
...
# docker push jheinecke/conllueditor:2.33.1
