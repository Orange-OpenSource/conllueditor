...
# docker build -t jheinecke/conllueditor:2.14.0 .
...
# docker push jheinecke/conllueditor:2.14.0
...
COPY target/ConlluEditor-2.14.0-jar-with-dependencies.jar ./ConlluEditor.jar
