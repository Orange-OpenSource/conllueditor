...
ARG VERSION=2.22.4
# docker build --build-arg 2.22.4 -t jheinecke/conllueditor:2.22.4 .
# docker build --build-arg 2.22.4 -t jheinecke/conllueditor:latest .
...
# docker push jheinecke/conllueditor:2.22.4
