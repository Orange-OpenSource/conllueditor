...
# docker build -t jheinecke/conllueditor:2.10.2 .
...
# docker push jheinecke/conllueditor:2.10.2
...
COPY target/ConlluEditor-2.10.2-jar-with-dependencies.jar ./ConlluEditor.jar
