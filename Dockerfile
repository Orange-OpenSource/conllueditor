...
ARG VERSION=2.23.0
# docker build --build-arg 2.23.0 -t jheinecke/conllueditor:2.23.0 .
# docker build --build-arg 2.23.0 -t jheinecke/conllueditor:latest .
...
# docker push jheinecke/conllueditor:2.23.0
