...
ARG VERSION=2.32.0
# docker build --build-arg VERSION=2.32.0 -t jheinecke/conllueditor:2.32.0 .
# docker build --build-arg VERSION=2.32.0 -t jheinecke/conllueditor:latest .
...
# docker push jheinecke/conllueditor:2.32.0
