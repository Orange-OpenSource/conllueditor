...
# docker build -t jheinecke/conllueditor:2.17.0 .
...
# docker push jheinecke/conllueditor:2.17.0
...
COPY target/ConlluEditor-2.17.0-jar-with-dependencies.jar ./ConlluEditor.jar
