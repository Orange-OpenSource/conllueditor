...
# docker build -t jheinecke/conllueditor:2.9.0 .
# docker run -t --name conllueditor_290 -p 5555:5556 --user 1000:1000  -v </absolute/path/to/datadir>:/data  --env filename=tt.conllu jheinecke/conllueditor:latest
# docker push jheinecke/conllueditor:2.9.0 .
# docker push jheinecke/conllueditor:latest .

# docker exec -it conllueditor_290 /bin/sh

# stop and remove container docker rm --force conllueditor_290
...
COPY target/ConlluEditor-2.9.0-jar-with-dependencies.jar ./ConlluEditor.jar
