...
ARG VERSION=2.35.1
# docker build --build-arg VERSION=2.35.1 -t jheinecke/conllueditor:2.35.1 .
# docker build --build-arg VERSION=2.35.1 -t jheinecke/conllueditor:latest .
...
# docker push jheinecke/conllueditor:2.35.1
