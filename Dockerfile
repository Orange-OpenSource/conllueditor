...
ARG VERSION=2.32.1
# docker build --build-arg VERSION=2.32.1 -t jheinecke/conllueditor:2.32.1 .
# docker build --build-arg VERSION=2.32.1 -t jheinecke/conllueditor:latest .
...
# docker push jheinecke/conllueditor:2.32.1
