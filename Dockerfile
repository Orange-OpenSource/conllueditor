...
# docker build -t jheinecke/conllueditor:2.10.3 .
...
# docker push jheinecke/conllueditor:2.10.3
...
COPY target/ConlluEditor-2.10.3-jar-with-dependencies.jar ./ConlluEditor.jar
