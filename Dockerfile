...
# docker build -t jheinecke/conllueditor:2.11.2 .
...
# docker push jheinecke/conllueditor:2.11.2
...
COPY target/ConlluEditor-2.11.2-jar-with-dependencies.jar ./ConlluEditor.jar
