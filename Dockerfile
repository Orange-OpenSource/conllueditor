...
ARG VERSION=2.25.6
# docker build --build-arg 2.25.6 -t jheinecke/conllueditor:2.25.6 .
# docker build --build-arg 2.25.6 -t jheinecke/conllueditor:latest .
...
# docker push jheinecke/conllueditor:2.25.6 
