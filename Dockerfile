...
# docker build -t jheinecke/conllueditor:2.11.1 .
# docker build -t jheinecke/conllueditor:latest .
# docker run -t --name conllueditor -p 5555:5555 --user 1000:1000  -v </absolute/path/to/datadir>:/data  --env filename=tt.conllu jheinecke/conllueditor:latest
# docker push jheinecke/conllueditor:2.11.1
...
COPY target/ConlluEditor-2.11.1-jar-with-dependencies.jar ./ConlluEditor.jar
